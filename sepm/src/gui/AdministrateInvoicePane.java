	...
	protected class searchListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			try{
				...
				JOptionPane.showMessageDialog(null, "Bitte �berpr�fen Sie Ihre Datumseingabe auf korrekte Formatierung.");
				return;
			}
			filterTable();
		}
		...
		private RowFilter<? super TableModel, Object> createIdFilter() {
			try{
				...
				if(!inrField.getText().isEmpty()){
					JOptionPane.showMessageDialog(null, "Bitte �berpr�fen Sie die ID. Es scheint sich um keine Zahl zu handeln. Der Wert wird ignoriert.");
				}
			}
			return null;
		}
